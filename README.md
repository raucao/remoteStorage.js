*__NOTE:__* This is a legacy branch to use with old apps. It will remain being called **"stable"**, until version 0.7 emerges to a useful state. If you wish to start a new app, please use the **master** branch.
