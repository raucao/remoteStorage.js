define(
  ['require', './lib/platform', './lib/couch', './lib/dav', './lib/simple', './lib/webfinger', './lib/hardcoded', './lib/widget',
    './lib/baseClient', './lib/cache', './lib/storageEventClient', './lib/wireClient'],
  function (require, platform, couch, dav, simple, webfinger, hardcoded, widget, baseClient, cache, storageEventClient, wireClient) {
    var modules = {
      },
